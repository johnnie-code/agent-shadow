...
@patch("shadow.core.dependencies.detect_platform")
@patch("shadow.core.dependencies.validate_profile_compatibility")
def test_choose_and_validate_profile_android_v2(mock_compat, mock_detect, mock_is_android):
...
@patch("shadow.core.dependencies.detect_platform")
@patch("shadow.core.dependencies.validate_profile_compatibility")
def test_choose_and_validate_profile_android_fallback(mock_compat, mock_detect, mock_is_android):
    mock_is_android.return_value = True
    mock_detect.return_value = "Android / Termux"
...
@patch("shadow.core.dependencies.detect_platform")
@patch("shadow.core.dependencies.validate_profile_compatibility")
def test_choose_and_validate_profile_android_unsupported(mock_compat, mock_detect, mock_is_android):
    mock_is_android.return_value = True
    mock_detect.return_value = "Android / Termux"
    mock_compat.return_value = (False, "Dry-run failed")
